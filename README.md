...
🚀 SaaS Starter with Vite, Vue 3, Express, MySQL  🚀
</a></h1>
...
This template is a fullstack starter template with Vite, Vue 3, Express, MySQL, Sequelize, Docker and JWT Authentification.
